    ...
    public class CategoryController : Controller
    {
        ...
        public ActionResult MasterPosting(int CompanyId, string SessionId, string Name, string Code)
        {
            ...
            try
            {
                ...
                if (AccessToken == "")
                {
                    ...
                    objreg.SetLog("AlZajelCategory.log", "Invalid Token");
                    //FConvert.LogFile("AlZajelCategory.log", DateTime.Now.ToString() + " : Invalid Token");
                    var sMessage = "Token Should not be Empty";
                    objreg.SetLog("AlZajelCategory.log", sMessage);
                    //FConvert.LogFile("AlZajelCategory.log", DateTime.Now.ToString() + " : " + sMessage);
                ...
                if (isGroup == 0)
                {
                    ...
                    using (WebClient client = new WebClient())
                    {
                        ...
                        objreg.SetLog("AlZajelCategory.log", " PostingURL :" + PostingURL);
                        ...
                        if (lng.ResponseStatus.IsSuccess == true)
                        {
                            ...
                            if (res == 1)
                            {
                                objreg.SetLog("AlZajelCategory.log", "Data posted / updated to mobile app device");
                                //FConvert.LogFile("AlZajelCategory.log", DateTime.Now.ToString() + "Data posted / updated to mobile app device");
                            }
                        ...
                        else
                        {
                            ...
                            {
                                objreg.SetLog("AlZajelCategory.log", "Error Message for Category Master:" + item);
                                //FConvert.LogFile("AlZajelCategory.log", DateTime.Now.ToString() + "Error Message for Category Master:" + item);
                            ...
                            if (FailedListCount > 0)
                            {
                                ...
                                {
                                    objreg.SetLog("AlZajelCategory.log", "FailedList Message for Category Master with Master Id:" + item.FldId + " and Code:" + item.FldCode);
                                    //FConvert.LogFile("AlZajelCategory.log", DateTime.Now.ToString() + "FailedList Message for Category Master with Master Id:" + item.FldId + " and Code:" + item.FldCode);
            ...
            catch (Exception e)
            {
                errors1 = e.Message;
                Message = e.Message;
                objreg.SetLog("AlZajelCategory.log", " Error :" + errors1);
                //FConvert.LogFile("AlZajelCategory.log", DateTime.Now.ToString() + " Error :" + errors1);
            }
            return Json(new { Message = Message }, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult MasterDelete(int companyId, string Name, string Code)
        {
            ...
            try
            {
                ...
                {
                    client.Headers.Add("Content-Type", "application/json");
                    objreg.SetLog("AlZajelCategory.log", "Delete PostingURL :" + PostingURL);
                    var arrResponse = client.UploadString(PostingURL, sContent);
                    var lng = JsonConvert.DeserializeObject<Result>(arrResponse);
                    ...
                    if (lng.ResponseStatus.IsSuccess == true)
                    {
                        ...
                        objreg.SetLog("AlZajelCategory.log", "Delete Response" + Message);
                        //FConvert.LogFile("AlZajelCategory.log", DateTime.Now.ToString() + "Delete Response" + Message);
                    }
                    else
                    {
                        objreg.SetLog("AlZajelCategory.log", "Delete Failed Response" + lng.ResponseStatus.StatusMsg);
                        //FConvert.LogFile("AlZajelCategory.log", DateTime.Now.ToString() + "Delete Failed Response" + lng.ResponseStatus.StatusMsg);
        ...
        public string GetAccessToken()
        {
            ...
            {
                client.Headers.Add("Content-Type", "application/json");
                objreg.SetLog("AlZajelCategory.log", " AccessTokenURL :" + AccessTokenURL);
